dr = "C:/Users/Mohammed/OneDrive - Georgia Institute of Technology/NXOpen/"

file1 = 'Wing_Airfoil_w0'
file2 = 'Wing_Airfoil_w1'

filename = [dr+file1, dr+file2]  #List of all Airfoils
#filenames should include the directory without including the extension (.txt), yet they are a txt file
DG =    [3,3]          #Spline Degree
Upper = [25,25]    #Points on the Upper Limit
Lower = [25,25]    #Points on the Lower Limit
...
filename_1 = 'Ogive_Lines'
DG_1 = 3 # Degree of Spline
n_1 = 50 # number of Points
...
def Spline (filename, DG, n):
        with open(filename + ".txt", "r") as file:
            ...
            names = [line.strip() for line in file]
        for i in range (0,2):
            main (names[i*n:n*(i+1)], DG, 1, 1)
Spline (filename_1, DG_1, n_1)
