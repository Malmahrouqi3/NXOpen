#Haack.py
# Generate the points, connect them with a spline then add a third line to connect the last and first point
# First 50 points to define the nose shape
# nose rotation is about the y axis
# so that each point output is multiplied by either sin theta or cos theta

# in this code, generate .exp and .txt files for a set of 50 points
# in NX, make a spline, two more splines, then rotation about the axi
